...
function styleInfo(feature) {
  return {
    ...
    opacity: 1,
    fillOpacity: 1,
    fillColor: getColor(feature.au_ppm),
    color: "#000000",
    radius: getRadius(feature.au_ppm),
    stroke: true,
    weight: 0.5
  };
};
...
L.geoJson(data, {
  pointToLayer:function(feature,latlng) {
    ...
    return L.circleMarker(latlng);},
      ...
      style: styleInfo,
    onEachFeature: function(feature, layer) {layer.bindPopup("Magnitude: " + feature.properties.au_ppm + "<br>Location: " + feature.properties.rare_earth_predict);}
})
